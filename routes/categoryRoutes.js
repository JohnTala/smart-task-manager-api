...
router.post('/', validationRulesCategory, validateCategory, categoryController.createCategory);
/* #swagger.tags = ['Categories']
...
router.put('/:id', validationRulesCategory, validateCategory, categoryController.updateCategory);
/* #swagger.tags = ['Categories']
